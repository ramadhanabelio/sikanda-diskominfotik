...
@section('title', 'Tambah Sub Sub Kegiatan')
...
@section('content')
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        ...
        <ul class="breadcrumbs mb-3">
            ...
            <li class="nav-item">
                <a href="">Tambah Sub Sub Kegiatan</a>
            </li>
        </ul>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <form action="{{ route('sub-subtitles.store') }}" method="POST">
                <div class="card card-round">
                    <div class="card-header">
                        <div class="card-head-row card-tools-still-right">
                            <div class="card-title">Tambah Sub Sub Kegiatan</div>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-action">
                        ...
                        <a href="{{ route('sub-subtitles.index') }}" class="btn btn-dark">Batal</a>
                    </div>
                </div>
            </form>
        </div>
